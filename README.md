...
Le Vibe Coding, c'est déléguer l'écriture, les tests et le débogage à une IA tout en gardant le contrôle créatif.
    ...
    Aider : L'agent (comme Claude Code) qui manipule vos fichiers et Git pour vous.

    Open-Weight : Des modèles performants (Qwen, Codestral) utilisables gratuitement en local.

# Structure
local-llm-setup-fr.MD = procédure en **français**

local-llm-setup-en.MD = procedure in **english**

# Licence
Ce projet est sous licence MIT - libre de réutilisation pour la communauté open source.

# Références
Mon LinkedIn : [Julien P.](https://www.linkedin.com/in/julien-p-68834731/?locale=fr)
